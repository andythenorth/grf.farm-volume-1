====================================
FIRS Industry Replacement Set steeltown-v5-preview-1
====================================
New Industries and Cargos for OpenTTD

FIRS docs are published online:
  https://grf.farm/firs/steeltown-v5-preview-1/index.html

=======
GRF Name : FIRS Industry Replacement Set

This version of FIRS is created using repository version 6901
